...
import { MWWORKIMG, MWLOGOFooter, HCTLOGO } from "@/values/Constants/ImageConstants";
...
export default function FooterSec() {
    ...
    return (
        <Box sx={MUIStyle.FooterSec} id="contact">
            <Box sx={MUIStyle.MainFooterBox}>
                <Container maxWidth="xl">
                    <Box sx={MUIStyle.FooterRow}>
                        <Box sx={MUIStyle.FooterLogoBox}>
                            <Box component={"img"} src={HCTLOGO} alt="side Image" sx={MUIStyle.WorkImg} />
