            ...
            className="container">
                <div className="get-questions-inr-sec">
                    <div className="bnr-img-questions">
                        <img src="/images/fuelMemoriesImages/questions-bg-img1.png" alt="" />
                    </div>
                    <div className="row">
                        <div className="col-lg-7 col-md-10 col-sm-12">
                            <div className="left-questions-sec">
                                ...
                                <div className="questions-call-email-sec">
                                    <a href="tel:123-234-123400"><img src="/images/fuelMemoriesImages/call-icon-question.png" alt="" />+123 - 234 - 123400</a>
                                    <a href="mailto:hello@awesome.com"><img src="/images/fuelMemoriesImages/mail-icon-question.png" alt="" />hello@awesome.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
