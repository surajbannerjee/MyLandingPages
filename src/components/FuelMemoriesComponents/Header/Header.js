                    ...
                    <div className="row align-items-center justify-content-between">
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            <motion.div
                                ...
                                <Link href='#'><Image height={500} width={500} src="/images/fuelMemoriesImages/header-logo.png" alt="" /></Link>
                            </motion.div>
                        </div>
                        <div className="col-lg-9 col-md-9 col-sm-12">
                            <motion.div
                                ...
                                <a href="tel:123-234-123400" className="call-sec-header"><Image height={20} width={20} src="/images/fuelMemoriesImages/call-icon.png" alt="" />+123 - 234 - 123400</a>
                                <a href="#" className="login-btn-header"><Image height={20} width={20} src="/images/fuelMemoriesImages/login-icon1.png" alt="" /> Login</a>
                                <button className="open__nav__btn" ><Image height={20} width={20} src="/images/fuelMemoriesImages/open-menu-icon1.png" alt="" /></button>
                                <button className="close__btn__navbar" ><Image height={20} width={20} src="/images/fuelMemoriesImages/close-icon-nav.png" alt="" /></button>
                            </motion.div>
                        </div>
                    </div>
                </div>
